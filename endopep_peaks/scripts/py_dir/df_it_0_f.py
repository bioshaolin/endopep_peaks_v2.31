...
df_final_2 = df_final[['date','plate','bot_id','LC_F','sn_LC_F','HC_F','sn_HC_F','Intact_F','sn_Intact_F']]
df_final_2.columns = ['date','plate','bot_id','Peak_1_F','sn_Peak_1_F','Peak_2_F','sn_Peak_2_F','Intact_F','sn_Intact_F']
df_final_3 = df_final_2.copy()
df_final_2 = df_final_2.sort_values(['date', 'plate', 'bot_id'])
df_final_2 = df_final_2.reset_index(drop=True).style.applymap(highlight_7, subset=pd.IndexSlice[:, ['Peak_1_F','Peak_2_F','Peak_1_F5','Peak_2_F5','Intact_F']]) \
