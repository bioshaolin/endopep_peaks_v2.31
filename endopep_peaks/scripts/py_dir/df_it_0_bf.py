...
df_fin1 = pd.concat([df_bb,df_fb], axis=1, join_axes=[df_bb.index])
df_final = df_fin1
...
df_final_2 = df_final[['date','plate','bot_id','LC_B','sn_LC_B','HC_B','sn_HC_B',\
'Intact_B','sn_Intact_B','LC_F','sn_LC_F','HC_F','sn_HC_F','Intact_F','sn_Intact_F']]
df_final_2.columns = ['date','plate','bot_id','Peak_1_B','sn_Peak_1_B','Peak_2_B','sn_Peak_2_B',\
'Intact_B','sn_Intact_B','Peak_1_F','sn_Peak_1_F','Peak_2_F','sn_Peak_2_F','Intact_F','sn_Intact_F']
df_final_3 = df_final_2.copy()
df_final_2 = df_final_2.sort_values(['date', 'plate', 'bot_id'])
df_final_2 = df_final_2.reset_index(drop=True).style.applymap(highlight_3, subset=pd.IndexSlice[:, ['Peak_1_B','Peak_2_B','Intact_B']]) \
