...
df_final_2 = df_final[['date','plate','bot_id','LC_A','sn_LC_A','HC_A','sn_HC_A','Intact_A','sn_Intact_A']]
df_final_2.columns = ['date','plate','bot_id','Peak_1_A','sn_Peak_1_A','Peak_2_A','sn_Peak_2_A','Intact_A','sn_Intact_A']
