...
df_fin1 = pd.concat([df_eb,df_fb], axis=1, join_axes=[df_eb.index])
df_final = df_fin1
...
df_final_2 = df_final[['date','plate','bot_id','LC_E','sn_LC_E','HC_E','sn_HC_E','Intact_E','sn_Intact_E','LC_F','sn_LC_F','HC_F','sn_HC_F','Intact_F','sn_Intact_F']]
df_final_2.columns = ['date','plate','bot_id','Peak_1_E','sn_Peak_1_E','Peak_2_E','sn_Peak_2_E','Intact_E','sn_Intact_E','Peak_1_F','sn_Peak_1_F','Peak_2_F','sn_Peak_2_F','Intact_F','sn_Intact_F']
