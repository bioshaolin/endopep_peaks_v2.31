...
df_fin1 = pd.merge(pd.merge(df_bb,df_eb,on=['date','plate','bot_id']),df_fb,on=['date','plate','bot_id'])
...
df_final_2 = df_final[['date','plate','bot_id','LC_B','HC_B','Intact_B',\
'LC_E','HC_E','Intact_E','LC_F','HC_F','Intact_F']]
df_final_2.columns = ['date','plate','bot_id','Peak_1_B','Peak_2_B','Intact_B',\
...
df_4 = df_4.reset_index(drop=True).style.applymap(high_1, subset=pd.IndexSlice[:, ['Peak_1_B','Peak_2_B','Intact_B',\
'Peak_1_E','Peak_2_E','Intact_E','Peak_1_F','Peak_2_F','Intact_F']])
