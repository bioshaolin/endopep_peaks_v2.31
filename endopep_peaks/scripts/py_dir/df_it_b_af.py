...
df_final_2 = df_final[['date','plate','bot_id','LC_A','HC_A','Intact_A','LC_F','HC_F','Intact_F']]
df_final_2.columns = ['date','plate','bot_id','Peak_1_A','Peak_2_A','Intact_A','Peak_1_F','Peak_2_F','Intact_F']
...
df_4 = df_4.reset_index(drop=True).style.applymap(high_1, subset=pd.IndexSlice[:, ['Peak_1_A','Peak_2_A','Intact_A','Peak_1_F','Peak_2_F','Intact_F']])
