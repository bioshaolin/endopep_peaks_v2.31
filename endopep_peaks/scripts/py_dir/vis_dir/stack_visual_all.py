...
plot_10 = df_10['Peak_1_F'].plot(ax=axes[3,1],kind='bar', color=colors ,width=0.8)
...
plot_11 = df_11['Peak_2_F'].plot(ax=axes[4,1],kind='bar', color=colors ,width=0.8)
...
plot_12 = df_12['Intact_F'].plot(ax=axes[5,1],kind='bar', color=colors ,width=0.8)
...
axes[3,1].set_title('Peak_1_F', fontsize=7, loc='left')
axes[3,1].tick_params(axis='x', labelsize=4, bottom=True,top=False,labelbottom=False)
axes[4,1].set_title('Peak_2_F', fontsize=7, loc='left')
axes[4,1].tick_params(axis='x', labelsize=4, bottom=True,top=False,labelbottom=False)
axes[5,1].set_title('Intact_F', fontsize=7, loc='left')
axes[5,1].tick_params(axis='x', labelsize=4, bottom=True,top=False,labelbottom=True)
axes[5,1].get_xticklabels()[0].set_color('red')
axes[5,1].get_xticklabels()[1].set_color('red')
axes[5,1].get_xticklabels()[2].set_color('red')
...
axes[3,1].tick_params(axis='y', labelsize=7)
axes[4,1].tick_params(axis='y', labelsize=7)
axes[5,1].tick_params(axis='y', labelsize=7)
...
axes[3,1].set_facecolor('#D4D4D4')
axes[4,1].set_facecolor('#D4D4D4')
axes[5,1].set_facecolor('#D4D4D4')
...
sm_10.set_array([])
c10 = plt.colorbar(sm_10,ax=axc[3,0],pad=0.05 ,orientation='vertical')
c10.set_label('Peak_1_F', fontsize=7)

### f2 ###
sm_11 = plt.cm.ScalarMappable(cmap=colormap_4, norm=norm_f2)
sm_11.set_array([])
c11 = plt.colorbar(sm_11,ax=axc[3,1],pad=0.05 ,orientation='vertical')
c11.set_label('Peak_2_F', fontsize=7)

### if ###
sm_12 = plt.cm.ScalarMappable(cmap=colormap_4, norm=norm_f3)
sm_12.set_array([])
c12 = plt.colorbar(sm_12,ax=axc[3,2],pad=0.05 ,orientation='vertical')
