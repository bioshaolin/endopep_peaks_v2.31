...
plot_7 = df_7['Peak_1_E'].plot(ax=axes[3],kind='bar', color=colors ,width=0.8)
...
plot_8 = df_8['Peak_2_E'].plot(ax=axes[4],kind='bar', color=colors ,width=0.8)
...
plot_9 = df_9['Intact_E'].plot(ax=axes[5],kind='bar', color=colors ,width=0.8)
