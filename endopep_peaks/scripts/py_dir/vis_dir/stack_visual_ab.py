...
plot_4 = df_4['Peak_1_B'].plot(ax=axes[3],kind='bar', color=colors ,width=0.8, ylim=[1756.500,1763.700], fontsize=5)
...
plot_5 = df_5['Peak_2_B'].plot(ax=axes[4],kind='bar', color=colors ,width=0.8, ylim=[2277.700,2286.900], fontsize=5)
...
plot_6 = df_6['Intact_B'].plot(ax=axes[5],kind='bar', color=colors ,width=0.8)
