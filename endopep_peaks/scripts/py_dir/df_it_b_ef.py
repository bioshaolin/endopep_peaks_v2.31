...
df_fin1 = pd.merge(df_eb,df_fb ,on=['date','plate','bot_id'], how="left")
print(df_fin1)
...
df_final_2 = df_final[['date','plate','bot_id','LC_E','HC_E','Intact_E','LC_F','HC_F','Intact_F']]
df_final_2.columns = ['date','plate','bot_id','Peak_1_E','Peak_2_E','Intact_E','Peak_1_F','Peak_2_F','Intact_F']

df_final_3 = df_final_2.round(decimals=1)
df_final_3['Peak_1_E'].values[df_final_3['Peak_1_E'] > 0] = 1
df_final_3['Peak_2_E'].values[df_final_3['Peak_2_E'] > 0] = 1
df_final_3['Intact_E'].values[df_final_3['Intact_E'] > 0] = 1
...
df_4['Peak_1_E'] = np.where(np.logical_and(df_4['Peak_1_E']==0,df_4['Peak_2_E']==1) , -1 , df_4['Peak_1_E'])
df_4['Peak_2_E'] = np.where(np.logical_and(df_4['Peak_1_E']==1,df_4['Peak_2_E']==0) , -1 , df_4['Peak_2_E'])
...
df_4 = df_4.reset_index(drop=True).style.applymap(high_1, subset=pd.IndexSlice[:, ['Peak_1_E','Peak_2_E','Intact_E','Peak_1_F','Peak_2_F','Intact_F']])
