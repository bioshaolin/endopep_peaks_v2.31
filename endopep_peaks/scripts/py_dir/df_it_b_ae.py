...
df_fin1 = pd.merge(df_ab,df_eb ,on=['date','plate','bot_id'], how="left")
print(df_fin1)
...
df_final_2 = df_final[['date','plate','bot_id','LC_A','HC_A','Intact_A','LC_E','HC_E','Intact_E']]
df_final_2.columns = ['date','plate','bot_id','Peak_1_A','Peak_2_A','Intact_A','Peak_1_E','Peak_2_E','Intact_E']
