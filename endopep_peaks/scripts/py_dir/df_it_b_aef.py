...
df_fin1 = pd.merge(pd.merge(df_ab,df_eb,on=['date','plate','bot_id']),df_fb,on=['date','plate','bot_id'])
...
df_final_2 = df_final[['date','plate','bot_id','LC_A','HC_A','Intact_A','LC_E','HC_E','Intact_E','LC_F','HC_F','Intact_F']]
df_final_2.columns = ['date','plate','bot_id','Peak_1_A','Peak_2_A','Intact_A','Peak_1_E','Peak_2_E','Intact_E','Peak_1_F','Peak_2_F','Intact_F']
